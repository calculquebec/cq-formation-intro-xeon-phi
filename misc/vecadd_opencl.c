// Code copied by hand (by Dan Mazur dan.mazur@calculquebec.ca)
// from Heterogeneous Computing with OpenCL
// by Gaster, et. al. Page 32-38

//Guillimin compilation instructions:
//For Nvidia GPUs:
//module add CUDA_Toolkit
//nvcc -lOpenCL -o vecadd vecadd_opencl.c
//For Xeon Phis:
//module add ifort_icc/14.0 intel_opencl
//icc -lOpenCL -o vecadd vecadd_opencl.c
